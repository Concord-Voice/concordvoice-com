...
#
# Vendored from the "cure for AI slop" kit by Ege Celebi, MIT licensed:
# https://github.com/woosal1337/blog/tree/b912d5fa59f368253683af2ebfac64ad6d08312d/videos/ep01-the-cure-for-ai-slop
# Local changes vs upstream: this header, and encoding="utf-8" on open() so the
# em-dash scan cannot crash under a non-UTF-8 locale. Keep further edits minimal
# so an upstream refresh stays a small diff.
