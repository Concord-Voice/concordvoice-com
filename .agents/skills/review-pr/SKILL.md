...
Check against any `docs/policies/ai-generated-code-policy.md` and applicable `.Codex/rules/*.md` the repo provides:
...
- Cross-references to AGENTS.md (when the repo has one) are present where counts are stated
