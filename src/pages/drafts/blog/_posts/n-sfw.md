---
title: "[N]SFW and When We Have to Intervene"
description: "Where the line sits, who draws it, and the narrow set of cases where a privacy-first platform still has to step in."
pubDate: 2026-05-22
category: "Policy"
tags: ["moderation", "safety", "policy"]
readingTime: 23
slug: "n-sfw"
---

One of the things we despise about content policies on other platforms is the vagueness. You get a wall of legalese that says "sexually explicit or suggestive content," and then you're left guessing where the line is until you get banned for posting a Renaissance painting or a breastfeeding photo. Meanwhile, actual harmful content runs rampant because the moderation team is too busy playing whack-a-mole with nipples.

We're not doing that. If we're going to require content labeling on the platform, the least we can do is tell you exactly what we mean. No ambiguity, no "we'll know it when we see it," no retroactive enforcement of rules we never clearly stated.

So here it is. This is what Concord Voice explicitly defines as NSFW content; content that must be labeled as such and segregated from users under 18. And below that, the content that is never allowed anywhere on the Concord Voice Network, period.

## First, a Reminder: How NSFW Labeling Works on Concord

Concord Voice doesn't have a central moderation team reviewing your content. We can't; End-to-End Encryption means we literally cannot read your messages or hear your calls, and that's by design.
...
This is the big one, and the one most platforms fumble by being either absurdly restrictive or uselessly vague.
...
**Sex work promotion.** Direct promotion of personal adult content (e.g., linking to adult subscription platforms, soliciting paid sexual content or services). This isn't a moral judgment; by all means, make your paper, boo boo. Just ensure it’s posted in an appropriate area.

**The following is NOT NSFW:**

**Non-sexual nudity.** Nudity in medical, educational, artistic, or documentary contexts. Breastfeeding. Classical art. Anatomy diagrams. Figure drawing references. If the nudity isn't sexual in nature, it doesn't require an NSFW flag.

**Discussions about sex.** Talking about sex education, sexual health, relationships, consent, or sexuality as a topic doesn't make a channel NSFW. A channel becomes NSFW when it hosts explicit depictions, not when people have mature conversations.

**Shirtless photos.** Regardless of gender. We're not going to be the platform that bans beach photos. If you can wear it (or lack the wear thereof) in public, non-age-restrictive places, you can post it.
...
**Historical and educational content.** War history, forensic science, medical education, and similar contexts where the graphic nature serves an educational purpose.

## Drugs and Controlled Substances

**The following is NSFW and must be labeled:**

**Explicit drug use depictions.** Imagery, video, or detailed instructional content showing the active use, preparation, or manufacture of illegal controlled substances. This includes content that functions as a how-to guide for drug use or production.

**Promotion of recreational drug use. **Content that actively encourages or glamorizes the use of controlled substances, particularly when targeted at or accessible to minors.

**The following is NOT NSFW:**

**Discussion of drugs. **Harm reduction information, drug policy discussions, personal experiences shared in a non-promotional context, medical marijuana discussions, and similar conversations. We're not going to label a channel NSFW because someone talked about their prescription medication or their opinion on drug legalization.

**Alcohol and tobacco content.** Legal substances don't trigger NSFW labeling on their own. Yes, these are restricted to certain ages in most jurisdictions, but the internet has largely settled on 18+ as the NSFW threshold, and we're not going to pretend a photo of a beer is equivalent to graphic content.
...
**Discussion of gambling.** Talking about poker strategy, discussing sports odds, and sharing casino experiences.

**Play-money or points-based games.** Community poker nights with no real stakes, prediction markets with imaginary points, and in-game currency betting that is more than one step removed, as defined above.

## What About Everything Else?

You'll notice some things that are conspicuously absent from this list.

**Profanity** is not NSFW. Adults swear. Teenagers swear. Swearing is a normal feature of human communication, and we're not going to require a content label because someone drops an F-bomb in general chat.
...
**Humanoid characters.** This policy applies to all characters that are human-adjacent in form, including but not limited to ‘monsters’, furry/anthro characters, cyborgs, elves, aliens, demons, and any other fantasy or fictional species. If the character's design borrows from the human form to a degree where sexual characteristics are recognizable as human, it must pass the **Test of Intent**.
...
**Human lower body:** Depicting any human or human-analogous genitalia, or a bipedal lower body structured around human proportions (hips, thighs, knees, calves)

**Human limbs:** Arms, hands, fingers, legs, feet, or toes that are structured or articulated in a recognizably human manner, even if stylized (e.g., four or five fingers rather than paws or claws)
...
We can hear the question already: "*You keep saying you can't read our messages because of End-to-End Encryption. So how exactly do you enforce any of this?"*

Good question. Honest answer: We rely on you.

E2EE means we cannot proactively monitor content. We cannot scan messages, flag images, or run classifiers on your voice calls. That's the architectural tradeoff of real encryption, and we accept it. But what E2EE does not prevent is a user in a server looking around, seeing something truly egregious, and telling us about it.
...
**1. You initiate the report.** From within the server or channel, you select the option to report a violation. You'll be asked to categorize the violation (NSFW labeling failure, prohibited content, illegal activity) and provide a written description of what you've witnessed.

**2. You select the evidence.** This is the part we need to be completely transparent about, because it involves the one and only exception to our "we never see your messages" principle.
...
Reports are triaged automatically first. Automated review examines the report metadata, categorization, and attached evidence against known patterns and volume thresholds. Multiple reports against the same server or user are correlated and escalated.

If automated review flags a report as credible and serious, it's escalated to our human Trust & Safety team for manual review. A human being looks at the evidence, evaluates the violation, and determines the appropriate action.

**4. Enforcement actions.**

For **NSFW labeling violations** (servers hosting unlabeled explicit content in channels accessible to minors), the server owner receives a warning and a deadline to correctly label their channels. Repeated violations result in the server being forcibly labeled or removed from the network.
...
**Platform action. **Once law enforcement has what they need (or if no preservation is required), the offending accounts are permanently banned, the server is removed from the Concord Voice Network, and all associated accounts are flagged. This is not a suspension or a warning. This is a permanent, irreversible removal.

### Report Abuse Policy

The reporting system exists to protect people. It is not a weapon, and we will not allow it to become one.

Because our reporting process is uniquely powerful, being the one mechanism through which decrypted message content can be surfaced to Concord Voice, abusing it is a serious matter. A false report doesn't just waste our time; it can trigger a review pipeline that involves human eyes on someone's private, encrypted messages. That is a privilege extended to users in the service of safety, and we treat its misuse accordingly.

We distinguish between two categories of report abuse because intent matters, and the consequences should match.

#### **Frivolous Reports**

A frivolous report is one that clearly doesn't constitute a violation under our policies. Someone said something you disagree with. A server has content you personally find distasteful, but that doesn't fall into any prohibited or NSFW category. You reported a channel because you got into an argument with a moderator. You didn't read the policy and assumed "offensive" meant "reportable."

These aren't malicious; they're just careless, lazy, or born of frustration. We get it. But they still clog the pipeline and divert resources from reports that involve actual victims and potential crimes.

**Escalation for frivolous reports:**

**First offense:** The report is dismissed, and you receive an educational notice explaining why it didn't meet the threshold, with a link to the content policy. No penalty.

**Second offense:** A formal warning is issued to your account. You are reminded that continued misuse will result in restrictions.

**Third offense:** A **reporting timeout** is applied to your account. You will be unable to submit reports for a defined cooldown period (30 days). You can still use the platform normally; you just can't file reports.

**Continued abuse:** The timeout period extends with each subsequent offense. If a pattern of persistent frivolous reporting is established, your reporting access may be revoked indefinitely.

#### **Malicious Reports**

A malicious report is one that is deliberately fabricated, manipulated, or coordinated to cause harm to another user or server. This includes:

**Fabricating evidence.** Submitting screenshots that have been doctored, or manipulating the context of messages to misrepresent what was said or done.

**Coordinated false reporting.** Organizing or participating in a campaign to flood the reporting system with false reports against a specific user or server, with the intent to trigger enforcement action against someone who hasn't violated any policy.

**Weaponizing the system.** Filing reports as retaliation, harassment, or as a tool to silence, deplatform, or intimidate another user, knowing that the content in question does not violate our policies.

**Exploiting the decryption mechanism.** Filing false reports for the purpose of causing someone's encrypted messages to be surfaced and reviewed, when no genuine violation exists. This is a direct abuse of the trust model that makes the reporting feature possible.

Malicious reporting is not a misunderstanding. It is a deliberate act that undermines the platform's safety infrastructure and violates the trust of every user who depends on it. We treat it as a policy violation in its own right.

**Escalation for malicious reports:**

**First substantiated offense:** Immediate **reporting timeout** (minimum 90 days) and a formal warning. The report is flagged in your account history, which is sustained for six months.

**Second offense: Account suspension** for a defined period, during which you cannot access the platform. Length is determined by the severity and scope of the abuse.

**Third offense or severe first offense** (e.g., large-scale coordinated campaigns, fabrication of CSAM reports to weaponize the most serious category): **Permanent account ban.** This is irreversible.

**How we determine abuse:**

Report abuse determinations are made during the standard review pipeline. When a report is reviewed and found to have no basis in our policies, the reviewer flags it for further evaluation. A single dismissed report is not automatically treated as abuse; people make honest mistakes, and some situations are genuinely ambiguous. Abuse findings require a pattern of frivolous reporting or clear evidence of malicious intent (fabricated evidence, coordination with other accounts, retaliatory timing, etc).

We are not in the business of punishing people for reporting in good faith. If you see something that genuinely concerns you, report it. If it turns out not to be a violation, that's fine. That's the system working. The policy above targets those who use the reporting system as a tool for personal grievances rather than as a safety mechanism for the community.
...
We will publish periodic transparency reports detailing, in aggregate:

The number of reports received, by category

The number of reports escalated to human review

The number of reports referred to law enforcement

The number of servers removed and accounts banned

The categories of violations that resulted in enforcement action

The number of reports dismissed as frivolous or malicious
...
Our approach to content policy is rooted in two simple principles:
