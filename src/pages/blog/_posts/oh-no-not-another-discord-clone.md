...
- Nobody profits from your data, because nobody can see it. No ads. No telemetry. We actually ripped Sentry back out (that's its own Dev Series story). No data business. Subscriptions are the model. E2EE-everywhere isn't just a privacy feature; it's a business-model commitment we can't quietly walk back later.
- Source-available today, and it outlives us. Concord is source-available under our [CVSL 1.0 license](/license), which converts to AGPL-3.0 automatically in 2030. If the company gets hit by a bus, the project doesn't die with it.
